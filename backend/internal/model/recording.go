...
type Recording struct {
	...
	QuestionID      uint      `gorm:"index;index:idx_recordings_question_sort,priority:1;not null" json:"question_id"`
	...
	SortOrder       int       `gorm:"not null;default:0;index:idx_recordings_question_sort,priority:2" json:"sort_order"`
